    ...
    public partial class FrmMain : Form
    {
                ...
                if (txtUsername.Text != "")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow kolom in ds.Tables[0].Rows)
                        {
                            ...
                            txtNama.Text = kolom["nama_pengguan"].ToString();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtPassword.Text != "" && txtNama.Text != "" && txtUsername.Text != "" && txtID.Text != "")
                {
                    ...
                    query = string.Format("update tbl_pengguna set password = '{0}', nama_pengguan = '{1}', level = '{2}' where id_pengguna = '{3}'", txtPassword.Text, txtNama.Text, CBLevel.Text, txtID.Text);
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.Columns[3].HeaderText = "Nama Pengguan";
